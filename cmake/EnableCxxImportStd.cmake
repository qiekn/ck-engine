...
# CMake 4.0.2 + MSVC may fail. Consider using the latest version of CMake (>= 4.1)
...
if(EXISTS "${_tmp}")
  message(STATUS "Using cached cmExperimental.cxx: ${_tmp}. "
    "If you wish to refresh it (e.g. CMake version changed), delete this file manually."
  )
else()
  ...
  if(NOT _dl_exit EQUAL 0)
    message(FATAL_ERROR
      "Failed to download cmExperimental.cxx. Download status: ${_dl_status}"
    )
  endif()
endif()
