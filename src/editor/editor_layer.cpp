...
void EditorLayer::OnAttach() {
  ...
  icon_play_ = Texture2D::Create("assets/icons/play_button.png");
  icon_simulate_ = Texture2D::Create("assets/icons/simulate_button.png");
  icon_stop_ = Texture2D::Create("assets/icons/stop_button.png");
...
void EditorLayer::OnOverlayRender() {
  ...
  if (show_physics_colliders_) {
    ...
    {
      auto view =
          active_scene_->GetAllEntitiesWith<TransformComponent, CircleCollider2DComponent>();
      for (auto entity : view) {
