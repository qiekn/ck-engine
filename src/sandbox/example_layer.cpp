...
ExampleLayer::ExampleLayer() : ck::Layer("Example"), camera_controller_(16.0f / 9.0f) {
  // clang-format off
    float vertices[] = {
      // Position         // Color
...
void ExampleLayer::OnUpdate(ck::DeltaTime dt) {
...
void ExampleLayer::OnEvent(ck::Event& event) { camera_controller_.OnEvent(event); }
